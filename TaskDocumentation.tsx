                ...
                {displayed.map((r: any) => {
                  ...
                  return (
                    <button
                      ...
                      className={`group relative aspect-square rounded-lg overflow-hidden bg-muted border transition-all ${
                        isChecked
                    ...
                    >
                      ...
                      {selectMode && (
                        <div className={`absolute top-2 start-2 w-5 h-5 rounded flex items-center justify-center border-2 transition-colors ${
                      ...
                      {!selectMode && (
                        <button
                          ...
                          className="absolute top-1.5 start-1.5 w-6 h-6 bg-black/60 hover:bg-red-600 rounded-full items-center justify-center text-white transition-colors opacity-0 group-hover:opacity-100 flex"
                        >
