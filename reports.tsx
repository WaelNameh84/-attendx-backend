...
import { useGetAttendanceReport, useListUsers, useGetMe, getGetAttendanceReportQueryKey, getGetMeQueryKey } from "@workspace/api-client-react";
...
export default function ReportsPage() {
  ...
  const fetchPayrollForPDF = async (): Promise<{ data: any | null; error: string | null }> => {
    ...
    try {
      ...
      const res = await authFetch("/api/payroll/calculate", {
        method: "POST",
        headers,
        body: JSON.stringify({ userId: uid, period }),
      });
