...
import { useUpdateSettings, useChangePassword, getGetSettingsQueryKey, useGetMe } from "@workspace/api-client-react";
...
export default function SettingsPage() {
  ...
  const { appName, appLogo, logoWidth, logoHeight, setAppName, setAppLogo, setLogoWidth, setLogoHeight } = useAppConfig();
              ...
              <div className="space-y-3 pt-1">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      value={logoW}
                      onChange={e => { const v = Number(e.target.value); setLogoW(v); setLogoWidth(v); }}
                  ...
                  <div className="space-y-1.5">
                    ...
                    <input
                      type="range" min={24} max={300} step={4}
                      value={logoH}
                      onChange={e => { const v = Number(e.target.value); setLogoH(v); setLogoHeight(v); }}
                      className="w-full accent-primary h-1.5 cursor-pointer"
                    />
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="flex gap-2">
                    <div className="space-y-1">
                      ...
                      <Input
                        ...
                        value={logoW}
                        onChange={e => { const v = Math.max(24, Math.min(300, Number(e.target.value))); setLogoW(v); setLogoWidth(v); }}
                    ...
                    <div className="space-y-1">
                      ...
                      <Input
                        type="number" min={24} max={300}
                        value={logoH}
                        onChange={e => { const v = Math.max(24, Math.min(300, Number(e.target.value))); setLogoH(v); setLogoHeight(v); }}
                        className="w-20 h-7 text-xs font-mono"
                      />
                    </div>
                  </div>
                  <div
                    ...
                    style={{ width: logoW, height: logoH, maxWidth: 120, maxHeight: 120 }}
                ...
                <button
                  type="button"
                  onClick={() => { setLogoW(64); setLogoH(64); setLogoWidth(64); setLogoHeight(64); }}
                  className="text-xs text-muted-foreground hover:text-foreground underline"
                >
                  {isArabic ? "إعادة تعيين (64×64)" : "Reset to default (64×64)"}
                </button>
              </div>
            </div>
