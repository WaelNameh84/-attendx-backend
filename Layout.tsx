...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    { href: "/bonuses", icon: Award, label: isAdmin ? "المكافآت والخصومات" : "مكافآتي" },
    { href: "/work-requests", icon: ClipboardList, label: "الطلبات والأذونات" },
    { href: "/work-reports", icon: Camera, label: "توثيق العمل" },
    { href: "/salary-advances", icon: Banknote, label: "طلبات السلفة" },
    { href: "/reports", icon: BarChart3, label: t("reports") },
    ...(isAdmin ? [{ href: "/clear-reports", icon: Trash2, label: "مسح التقارير" }] : []),
    { href: "/messages", icon: MessageSquare, label: "الرسائل", badge: unreadMsgCount },
